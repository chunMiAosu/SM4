...
public class SM4_3
{
    ...
    static byte[][] sbox = {{(byte) 0xD6, (byte) 0x90, (byte) 0xE9, (byte) 0xFE, (byte) 0xCC, (byte) 0xE1,
    ...
    static int[] ck = {0x00070E15, 0x1C232A31, 0x383F464D, 0x545B6269, 0x70777E85, 0x8C939AA1, 0xA8AFB6BD, 0xC4CBD2D9
            , 0xE0E7EEF5, 0xFC030A11, 0x181F262D, 0x343B4249, 0x50575E65, 0x6C737A81, 0x888F969D, 0xA4ABB2B9,
            0xC0C7CED5, 0xDCE3EAF1, 0xF8FF060D, 0x141B2229, 0x30373E45, 0x4C535A61, 0x686F767D, 0x848B9299,
            0xA0A7AEB5, 0xBCC3CAD1, 0xD8DFE6ED, 0xF4FB0209, 0x10171E25, 0x2C333A41, 0x484F565D, 0x646B7279};
    static int[] lookup0 = {0x8ed55b5b, 0xd0924242, 0x4deaa7a7, 0x6fdfbfb, 0xfccf3333, 0x65e28787, 0xc93df4f4,
    ...
    static int[] lookup1 = {0x5b8ed55b, 0x42d09242, 0xa74deaa7, 0xfb06fdfb, 0x33fccf33, 0x8765e287, 0xf4c93df4,
    ...
    static int[] lookup2 = {0x5b5b8ed5, 0x4242d092, 0xa7a74dea, 0xfbfb06fd, 0x3333fccf, 0x878765e2, 0xf4f4c93d,
    ...
    static int[] lookup3 = {0xd55b5b8e, 0x924242d0, 0xeaa7a74d, 0xfdfbfb06, 0xcf3333fc, 0xe2878765, 0x3df4f4c9,
    ...
    /*    byte[] plaintext = {(byte) 0x01, (byte) 0x23, (byte) 0x45, (byte) 0x67, (byte) 0x89, (byte) 0xAB, (byte) 0xCD
        ...
        long fileLength = fileSize * 1024 * 1024;
        //生成测试文件
        ...
        File writeFile = writeFile = new File("./timeData_3.csv");;
        BufferedWriter writerText =  new BufferedWriter(new FileWriter(writeFile,true));
        writerText.newLine();
        writerText.write(fileSize + "," + time_iterativeOperation + "," + time_reverseOrderTrans +"," +(all_endTime - all_startTime) );
        writerText.flush();
        writerText.close();
        System.out.print("32次迭代运算所用时间:" + time_iterativeOperation + "ms");
        System.out.println();
        System.out.print("反序变换所用时间:" + time_reverseOrderTrans + "ms");
        System.out.println();
        System.out.print("总时间:" + String.valueOf(all_endTime - all_startTime) + "ms");
        System.out.println();
    ...
    private static void getTable()
    {
        ...
        byte[][] I = new byte[32][32];
        byte[][] L = new byte[32][32];
        for (int i = 0; i < 32; i++)
        {
            for (int j = 0; j < 32; j++)
            {
        ...
        for (int i = 0; i < 32; i++)
        {
            ...
            {
                L[i][j] =
                        (byte) (I[i][j] ^ I[(i + 2) % 32][j] ^ I[(i + 10) % 32][j] ^ I[(i + 18) % 32][j] ^ I[(i + 24) % 32][j]);
        ...
        for (int i = 0; i < 256; i++)
        {
            ...
            System.out.print("0x" + Integer.toHexString(lookup0[i]) + ",");
        }
        ...
        for (int i = 0; i < 256; i++)
        {
            ...
            System.out.print("0x" + Integer.toHexString(lookup1[i]) + ",");
        }


        //生成第三张表
        System.out.println();
        System.out.println("第三张表：");
        for (int i = 8; i < 16; i++)
        {
            I[i][i] = 0;
        }
        ...
        for (int i = 0; i < 256; i++)
        {
            ...
            System.out.print("0x" + Integer.toHexString(lookup2[i]) + ",");
        }

        //生成第四张表
        System.out.println();
        System.out.println("第四张表：");
        for (int i = 16; i < 24; i++)
        {
            I[i][i] = 0;
        }
        ...
        for (int i = 0; i < 256; i++)
        {
            ...
            System.out.print("0x" + Integer.toHexString(lookup3[i]) + ",");
        }
